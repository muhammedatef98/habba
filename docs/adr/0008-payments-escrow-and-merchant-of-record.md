...
§1 lists escrow as a core differentiator: _"Money is authorised at booking, captured only after the
customer confirms completion."_ §3 specifies Moyasar, _"Escrow via authorise/capture."_
