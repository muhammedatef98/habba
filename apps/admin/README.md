...
| الكتالوج           | Services and prices, cities, makes and models, maintenance items and rules, commission, VAT, invoice sellers, inspection templates (and which one each service files)                                                                            |
