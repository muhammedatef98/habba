    ...
    >
      ...
      >
        <div>
          ...
          >
            {state.stage === 'enrol'
              ? 'التحقّق بخطوتين إلزامي لكل حسابات لوحة التشغيل. امسح الرمز بتطبيق مصادقة مثل Google Authenticator أو Microsoft Authenticator، ثم أدخل الرمز المكوّن من 6 أرقام.'
              : 'أدخل الرمز المكوّن من 6 أرقام من تطبيق المصادقة. يُطلب مرة كل 8 ساعات.'}
          </p>
        </div>
