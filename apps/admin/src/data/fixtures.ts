...
function seed(): State {
  ...
  const settings: Row[] = [
    ...
    setting(
      ...
      'boolean',
      'features',
      'تصوير المشكلة قبل الطلب',
      null,
      true,
      30,
    ),
    setting(
      'feature_ownership_transfer',
      true,
      'boolean',
      'features',
      'نقل ملكية السيارة',
    ...
    setting('feature_habba_report', true, 'boolean', 'features', 'تقرير هبّة', null, true, 50),
    setting(
      'feature_provider_applications',
      true,
      'boolean',
      'features',
      'قبول طلبات الانضمام كفنّي',
      null,
      true,
      60,
    ),
    setting('feature_guest_login', true, 'boolean', 'features', 'الدخول كضيف', null, true, 70),
    setting(
      'feature_email_login',
      true,
      'boolean',
    ...
    setting(
      ...
      'text',
      'app',
      'أقل إصدار مسموح من التطبيق',
      null,
      true,
      80,
      'مثل 1.4.0 — النسخ الأقدم تعرض «حدّث التطبيق» ولا تفتح.',
    ),
    setting('app_store_url', '', 'text', 'app', 'رابط التطبيق في App Store', null, true, 90),
    setting('play_store_url', '', 'text', 'app', 'رابط التطبيق في Google Play', null, true, 100),
    setting(
      'terms_url',
      '',
      'text',
      ...
      true,
      10,
      'يظهر في شاشة الدخول وفي «حسابي». يبدأ بـ https://',
    ),
    setting(
      'privacy_url',
      '',
      ...
      true,
      20,
      'مطلوب لنشر التطبيق في App Store وGoogle Play، ولنظام حماية البيانات الشخصية.',
    ),
    setting(
      'habba_report_valid_days',
      90,
      'integer',
      'legal',
      'مدة صلاحية رابط تقرير هبّة',
      'يوم',
      false,
      30,
      'للتقارير الجديدة فقط. التقرير الصادر يبقى بالمدة التي صدر بها.',
      1,
      365,
    ),
