...
insert into public.profiles (id, full_name, phone) values
  ('11111111-0000-4000-8000-000000000001', 'العميل', '+966501000001'),
  ('22222222-0000-4000-8000-000000000002', 'الفنّي', '+966501000002'),
  ('33333333-0000-4000-8000-000000000003', 'المشغّل', '+966501000003');

select test.grant_role('22222222-0000-4000-8000-000000000002', 'technician');
select test.grant_role('33333333-0000-4000-8000-000000000003', 'ops');
...
select test.become('22222222-0000-4000-8000-000000000002');
select public.record_completion_evidence('f0000000-0000-4000-8000-000000000001', 91200, test.completion_photos('f0000000-0000-4000-8000-000000000001'));
select test.become('11111111-0000-4000-8000-000000000001');
