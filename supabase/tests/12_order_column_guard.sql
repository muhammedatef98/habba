...
insert into public.profiles (id, full_name, phone, role) values
  ('11111111-0000-4000-f000-000000000001', 'العميل',   '+966507000001', 'customer'),
  ('22222222-0000-4000-f000-000000000002', 'الفنّي',   '+966507000002', 'technician'),
  ('44444444-0000-4000-f000-000000000004', 'فنّي آخر', '+966507000004', 'technician');
