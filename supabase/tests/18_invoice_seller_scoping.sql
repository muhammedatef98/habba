...
insert into public.profiles (id, full_name, phone, role) values
  ('11111111-0000-4000-8888-000000000001', 'صاحب الورشة', '+966509400001', 'technician'),
  ('22222222-0000-4000-8888-000000000002', 'زبون له فاتورة', '+966509400002', 'customer'),
  ('33333333-0000-4000-8888-000000000003', 'زبون غريب', '+966509400003', 'customer');
