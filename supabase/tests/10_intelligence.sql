...
insert into public.profiles (id, full_name, phone) values
  ('11111111-0000-4000-c000-000000000001', 'المالك', '+966505000001'),
  ('22222222-0000-4000-c000-000000000002', 'الورشة', '+966505000002'),
  ('33333333-0000-4000-c000-000000000003', 'المشغّل', '+966505000003');

select test.grant_role('22222222-0000-4000-c000-000000000002', 'workshop_admin');
select test.grant_role('33333333-0000-4000-c000-000000000003', 'ops');
