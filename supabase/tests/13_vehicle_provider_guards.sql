...
insert into public.profiles (id, full_name, phone, role) values
  ('11111111-0000-4000-1111-000000000001', 'المالك', '+966508000001', 'customer'),
  ('22222222-0000-4000-1111-000000000002', 'الفنّي', '+966508000002', 'technician'),
  ('33333333-0000-4000-1111-000000000003', 'المشغّل', '+966508000003', 'ops');
